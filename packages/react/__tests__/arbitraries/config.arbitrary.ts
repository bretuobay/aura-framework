...
export const arbNetworkQuality: fc.Arbitrary<NetworkQuality> = fc.constantFrom(...allNetworkQualities);

const allLayoutStrategies: LayoutStrategy[] = ['none', 'reserve-space', 'skeleton', 'host-default'];
export const arbLayoutStrategy: fc.Arbitrary<LayoutStrategy> = fc.constantFrom(...allLayoutStrategies);
